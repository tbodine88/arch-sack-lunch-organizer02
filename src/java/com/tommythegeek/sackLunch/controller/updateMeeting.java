...
public class updateMeeting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updateMeeting</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet updateMeeting at " + request.getContextPath() + "</h1>");
            out.println("New date for meeting " +ed_meetingID + " " + ed_month + " "+ ed_day +" " + ed_year);
            out.println("</body>");
            out.println("</html>");
        }
    }
